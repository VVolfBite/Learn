...
![img](./assets/a6175dbdd20cc35d9fab543bbc269917.png)
...
**作者****Github****：**semlinker (阿宝哥) · GitHub
...
Blob（Binary Large Object）表示二进制类型的大对象。在[数据库管理](https://cloud.tencent.com/product/dmc?from_column=20065&from=20065)系统中，将二进制数据存储为一个单一个体的集合。Blob 通常是影像、声音或多媒体文件。在 JavaScript 中 Blob 类型的对象表示不可变的类似文件对象的原始数据。

对 Blob 感兴趣的小伙伴，可以阅读 《你不知道的 Blob》这篇文章。

#### 4.7 代码实践：发送二进制数据

![img](./assets/5900975dc529ddc7686889e656bc37c1.png)
...
![img](./assets/8a0c10c2f6733faeb589def1716446ec.png)
