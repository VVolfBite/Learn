...
- [Connector API](http://kafka.apache.org/documentation.html#connect)允许构建和运行可重用的生产者或消费者，能够把 Kafka主题连接到现有的应用程序或数据系统。例如，一个连接到关系数据库的连接器(connector)可能会获取每个表的变化。
  ...
  ![img](./assets/Kafka/kafka-apis.png)
...
![img](./assets/Kafka/log_anatomy.png)
...
![img](./assets/Kafka/log_consumer.png)
...
![img](./assets/Kafka/sumer-groups.png)
...
![img](./assets/Kafka/kakfa-principle.png)
...
![img](./assets/Kafka/kafka-workflow.jpg)
...
![img](./assets/Kafka/kafka-partition.jpg)
...
![img](./assets/Kafka/kafka-segement.jpg)
...
![img](./assets/Kafka/kafka-write-flow.png)
...
![img](./assets/Kafka/kafka-ack-slg.png)
...
![img](./assets/Kafka/kafka-ack=1.png)
...
![img](./assets/Kafka/kafka-leo.png)
...
![img](./assets/Kafka/zookeeper-store.png)
...
![img](./assets/Kafka/controller-leader.png)
...
![img](./assets/Kafka/kafka-consume-group.png)
...
![img](./assets/Kafka/zero-copy.png)
...
![img](./assets/Kafka/kafka-start.png)
...
![img](./assets/Kafka/kafka-producer-thread.png)
...
- 高级 API 缺点 
  ...
  **结果：**
  ...
  ![img](./assets/Kafka/kakfa-java-demo.png)
...
![img](./assets/Kafka/interceptor-demo.png)
...
![img](./assets/Kafka/kakfa-streams-flow.png'/>    
...
1. 需求： 实时处理单词带有”>>>”前缀的内容。例如输入”atguigu>>>ximenqing”，最终处理成 “ximenqing” 
   ...
   ![img](./assets/Kafka/kafka-streams-data-clean.png'/>
