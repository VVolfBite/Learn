...
>  **注意**：本文件是旧版 Linux 学习资料，内容较为全面但偏教程化。
> 
> **推荐使用新版模块化笔记**，更适合面试复习：
> -  [Linux - 目录](Linux%20-%20目录.md)（复习导航，从这里开始）
> -  [Linux - 高频判断](Linux%20-%20高频判断.md)（面试前必看）
...
- [模块结构](#模块结构)
- [复习路径](#复习路径)
- [旧版内容（以下为原始教程内容）](#旧版内容以下为原始教程内容)
- [前言](#前言)
- [一、常用操作以及概念](#一常用操作以及概念)
- [shutdown [-krhc] 时间 [信息]](#shutdown--krhc-时间-信息)
- [二、磁盘](#二磁盘)
- [三、分区](#三分区)
- [四、文件系统](#四文件系统)
- [五、文件](#五文件)
- [ls [-aAdfFhilnrRSt] file|dir](#ls--aadffhilnrrst-filedir)
- [mkdir [-mp] 目录名称](#mkdir--mp-目录名称)
- [touch [-acdmt] filename](#touch--acdmt-filename)
- [rm [-fir] 文件或目录](#rm--fir-文件或目录)
- [mv [-fiu] source destination](#mv--fiu-source-destination)
- [mv [options] source1 source2 source3 .... directory](#mv-options-source1-source2-source3--directory)
- [chmod [-R] xyz dirname/filename](#chmod--r-xyz-dirnamefilename)
- [chmod 754 .bashrc](#chmod-754-bashrc)
- [chmod [ugoa]  [+-=] [rwx] dirname/filename](#chmod-ugoa----rwx-dirnamefilename)
- [chmod a+w .bashrc](#chmod-aw-bashrc)
- [ln [-sf] source_filename dist_filename](#ln--sf-source_filename-dist_filename)
...
- [cat [-AbEnTv] filename](#cat--abentv-filename)
- [head [-n number] filename](#head--n-number-filename)
- [which [-a] command](#which--a-command)
- [whereis [-bmsu] dirname/filename](#whereis--bmsu-dirnamefilename)
...
新版 Linux 笔记按照"文件系统 → 权限管理 → Shell 操作 → 进程管理 → 网络诊断"的主线组织：

1. **[Linux - 目录](Linux%20-%20目录.md)** - 复习导航、知识地图
2. **[Linux - 文件与目录](Linux%20-%20文件与目录.md)** - 目录结构、路径、文件类型
3. **[Linux - 用户、用户组与权限](Linux%20-%20用户、用户组与权限.md)** - rwx 权限、chmod、chown
4. **[Linux - inode、block 与文件系统](Linux%20-%20inode、block%20与文件系统.md)**  高频
5. **[Linux - 硬链接与软链接](Linux%20-%20硬链接与软链接.md)**  高频
6. **[Linux - Shell 与重定向](Linux%20-%20Shell%20与重定向.md)** - 标准输入输出、管道
7. **[Linux - 常用命令与文本处理](Linux%20-%20常用命令与文本处理.md)** - grep、awk、tail
8. **[Linux - 进程管理](Linux%20-%20进程管理.md)**  高频 - 僵尸进程、孤儿进程
9. **[Linux - 进程间通信基础](Linux%20-%20进程间通信基础.md)** - 管道、信号、共享内存
10. **[Linux - 网络诊断与端口排查](Linux%20-%20网络诊断与端口排查.md)** - netstat、lsof
11. **[Linux - 高频判断](Linux%20-%20高频判断.md)**  必看 - 易混淆概念、面试误区

## 复习路径

### 面试前 30 分钟
1. [高频判断](Linux%20-%20高频判断.md)（10 分钟）
2. [inode、block 与文件系统](Linux%20-%20inode、block%20与文件系统.md)（10 分钟）
3. [硬链接与软链接](Linux%20-%20硬链接与软链接.md)（5 分钟）
4. [进程管理](Linux%20-%20进程管理.md) 的僵尸进程部分（5 分钟）

### 1 小时系统复习
按照新版目录的知识地图，从文件系统到网络诊断，逐层复习。
